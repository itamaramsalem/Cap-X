  ...
  return (
    <Dialog.Root open onOpenChange={(open) => { if (!open) onClose(); }}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-2xl w-full max-w-lg z-50 max-h-[90vh] flex flex-col overflow-hidden">
          ...
          <div className="overflow-y-auto flex-1">
            ...
            <div className="px-8 py-7 space-y-6">
              ...
              {speaker.sector && (
                <span className="inline-block font-dm-sans text-xs font-semibold uppercase tracking-widest bg-navy/8 text-navy px-3 py-1.5 rounded">
                  {speaker.sector}
                </span>
              )}
            </div>
          ...
          {/* Sticky RSVP button — always visible */}
          <div className="px-8 py-5 border-t border-navy/10 bg-white shrink-0">
            <button
              onClick={onRsvp}
              disabled={isFull}
